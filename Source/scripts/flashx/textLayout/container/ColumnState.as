package flashx.textLayout.container
{
   ...
   public class ColumnState
   {
      ...
      {
         var _loc6_:Number = param3.effectivePaddingTop;
         var _loc7_:Number = param3.effectivePaddingBottom;
         var _loc8_:Number = param3.effectivePaddingLeft;
         var _loc9_:Number = param3.effectivePaddingRight;
      ...
      tlf_internal function computeColumns() : void
      {
         ...
         if(this._blockProgression == BlockProgression.TB)
         {
            ...
            {
               _loc6_ = !!isNaN(this._compositionWidth)?Number(0):Number(this._compositionWidth - this._paddingRight - this._columnWidth);
               _loc8_ = -(this._columnWidth + this._columnGap);
               _loc11_ = this._columnWidth;
            }

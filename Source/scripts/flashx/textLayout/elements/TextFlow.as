package flashx.textLayout.elements
{
   ...
   public class TextFlow extends ContainerFormattedElement implements IEventDispatcher
   {
      ...
      tlf_internal function changeFlowComposer(param1:IFlowComposer, param2:Boolean) : void
      {
         ...
         {
            _loc3_ = FlowComposerBase.computeBaseSWFContext(!!this._flowComposer?this._flowComposer.swfContext:null);
            _loc4_ = FlowComposerBase.computeBaseSWFContext(!!param1?param1.swfContext:null);
            ...
            if(this._flowComposer)
            {
               ...
               {
                  this._flowComposer.getControllerAt(_loc5_++).clearSelectionShapes();
               }
            ...
            {
               this.applyUpdateElements(param2);
            }
         }
      }
      ...
      {
         return getElementByIDHelper(param1);
      }
      
      public function getElementsByStyleName(param1:String) : Array
      {
         var _loc2_:Array = new Array();
         getElementsByStyleNameHelper(_loc2_,param1);
         return _loc2_;
      }
      ...
      tlf_internal function applyUpdateElements(param1:Boolean) : Boolean
      {
         ...
         if(this._elemsToUpdate)
         {
            ...
            {
               _loc3_.applyDelayedElementUpdate(this,param1,_loc2_);
            }
      ...
      tlf_internal function mustUseComposer() : Boolean
      {
         ...
         {
            if(_loc2_.updateForMustUseComposer(this))
            {
               _loc1_ = true;
            }
         }
      ...
      tlf_internal function processModelChanged(param1:String, param2:FlowElement, param3:int, param4:int, param5:Boolean, param6:Boolean) : void
      {
         if(this.flowComposer)
         {
            param2.appendElementsForDelayedUpdate(this);
         }
         if(param6)
         {
            this._generation = _nextGeneration++;
         ...
         if(param4 > 0)
         {
            this.damage(param3 + param2.getAbsoluteStart(),param4,TextLineValidity.INVALID,param5);
         }
         if(this.formatResolver)
         {
            switch(param1)
      ...
      tlf_internal function processAutoSizeImageLoaded(param1:InlineGraphicElement) : void
      {
         if(this.flowComposer)
         {
            param1.appendElementsForDelayedUpdate(this);
         }
      }
      ...
      tlf_internal function normalize() : void
      {
         ...
         if(this.normalizeStart != -1)
         {
            ...
            normalizeRange(this.normalizeStart,_loc1_);
      ...
      override tlf_internal function doComputeTextLayoutFormat() : TextLayoutFormatValueHolder
      {
         var _loc1_:TextLayoutFormatValueHolder = !!this._hostFormatHelper?this._hostFormatHelper.getComputedPrototypeFormat():null;
         return FlowElement.createTextLayoutFormatPrototype(formatForCascade,_loc1_);
      }
      
      tlf_internal function getTextLayoutFormatStyle(param1:Object) : TextLayoutFormatValueHolder
      {
         ...
         var _loc3_:TextLayoutFormatValueHolder = _loc2_ as TextLayoutFormatValueHolder;
         return !!_loc3_?_loc3_:new TextLayoutFormatValueHolder(_loc2_);
      }
...
class HostFormatHelper
{
   ...
   public function getComputedPrototypeFormat() : TextLayoutFormatValueHolder
   {
      ...
      {
         if(this._format is TextLayoutFormat || this._format is TextLayoutFormatValueHolder)
         {
            _loc1_ = this._format;
         }
         else
         {
            _loc1_ = new TextLayoutFormatValueHolder(this._format);
         }

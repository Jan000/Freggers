package flashx.textLayout.elements
{
   ...
   public class FlowGroupElement extends FlowElement
   {
      ...
      override tlf_internal function getElementByIDHelper(param1:String) : FlowElement
      {
         var _loc3_:int = 0;
         var _loc4_:FlowElement = null;
         var _loc2_:FlowElement = super.getElementByIDHelper(param1);
         if(_loc2_ == null)
         {
            _loc3_ = 0;
            ...
            {
               _loc4_ = this.getChildAt(_loc3_);
               _loc2_ = _loc4_.getElementByIDHelper(param1);
               if(_loc2_ != null)
               {
                  break;
               }
      ...
      {
         var _loc4_:FlowElement = null;
         super.getElementsByStyleNameHelper(param1,param2);
         var _loc3_:int = 0;
         while(_loc3_ < this._numChildren)
         {
            _loc4_ = this.getChildAt(_loc3_);
            _loc4_.getElementsByStyleNameHelper(param1,param2);
            _loc3_++;
         }
      }
      ...
      public function replaceChildren(param1:int, param2:int, ... rest) : void
      {
         ...
         if(param1 < param2)
         {
            ...
            while(param1 < param2)
            {
               ...
               _loc13_.modelChanged(ModelChange.ELEMENT_REMOVAL,0,_loc13_.textLength);
         ...
         if(_loc7_)
         {
            ...
            while(_loc11_ < _loc7_)
            {
               ...
               this._numChildren++;
               _loc10_.setParentAndRelativeStart(this,_loc6_ + _loc17_);
               _loc17_ = _loc17_ + _loc10_.textLength;
               param1++;
               _loc11_++;
            }
            if(_loc17_)
            {
               ...
               {
                  _loc13_ = this.getChildAt(param1++);
                  _loc13_.setParentRelativeStart(_loc13_.parentRelativeStart + _loc17_);
               }
               updateLengths(_loc5_,_loc17_,true);
               _loc18_ = getEnclosingController(_loc6_);
               if(_loc18_)
               {
                  ContainerController(_loc18_).setTextLength(_loc18_.textLength + _loc17_);
               }
            }
            _loc11_ = 0;
            while(_loc11_ < _loc7_)
            {
               _loc10_ = _loc7_ == 1?_loc9_:_loc8_[_loc11_];
               _loc10_.modelChanged(ModelChange.ELEMENT_ADDED,0,_loc10_.textLength);
               _loc11_++;
            }
         }
         else
         {
            ...
            if(_loc19_ != null)
            {
               ...
               _loc19_.damage(_loc11_,1,FlowDamageType.GEOMETRY,false);
            }
         }
      }
      ...
      override tlf_internal function appendElementsForDelayedUpdate(param1:TextFlow) : void
      {
         ...
         {
            _loc3_ = this.getChildAt(_loc2_);
            _loc3_.appendElementsForDelayedUpdate(param1);
            _loc2_++;
         }
      }
   }
